...
/**
 * Stage 6 chip 1 visual regression baseline (v0.8.12)
 *
 * Captures full-page screenshots at 1280 (desktop) + 322 (iPad Mini) for chip-1 in-scope pages,
 ...
 *
 * Chip 1 scope: Layout shell + discipline 首页（/keiei）。chip 2-7 会扩到详情页 / 列表 / 学习日志。
 *
 * 前提（与现有 e2e 一致）:
 ...
 */
test.describe('Stage 6 chip 1 visual regression', () => {
