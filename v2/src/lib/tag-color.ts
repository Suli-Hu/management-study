 ...
 *
 * v0.8.20: accentVarFor (chip 17 v0.8.18 加的 hashToTagToken 路径) 已删 —
 *   page chrome accent 路径切到 v2/src/lib/resolve-accent.ts 的
 *   resolveAccentForSchool() (user-defined hex 直接用, IMPLEMENTATION.md L3 例外)。
 */
